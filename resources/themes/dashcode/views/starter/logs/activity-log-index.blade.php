        ...
        <div class="card starter-activity-stat starter-activity-stat-total">
            <div class="card-body flex items-center gap-3 px-4 pb-3 pt-4">
                ...
                <div class="overflow-hidden">
                    ...
                    <div class="starter-activity-stat-value">{{ \Aldhi88\StarterKit\Support\Starter\StarterNumber::decimal($totalChanges) }}</div>
                </div>
            </div>
        </div>
        <div class="card starter-activity-stat starter-activity-stat-today">
            <div class="card-body flex items-center gap-3 px-4 pb-3 pt-4">
                ...
                <div class="overflow-hidden">
                    ...
                    <div class="starter-activity-stat-value">{{ \Aldhi88\StarterKit\Support\Starter\StarterNumber::decimal($todayChanges) }}</div>
                </div>
            </div>
        </div>
        <div class="card starter-activity-stat starter-activity-stat-users">
            <div class="card-body flex items-center gap-3 px-4 pb-3 pt-4">
                ...
                <div class="overflow-hidden">
                    ...
                    <div class="starter-activity-stat-value">{{ \Aldhi88\StarterKit\Support\Starter\StarterNumber::decimal($activeActorCount) }}</div>
                </div>
            </div>
        </div>
    </div>
