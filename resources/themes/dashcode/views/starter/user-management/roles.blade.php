<div class="dashcode-roles-page">
    ...
    @if ($roleUsersModalOpen)
        <div class="modal dashcode-detail-modal show" tabindex="-1" role="dialog" aria-modal="true" aria-labelledby="role-users-modal-title" wire:click.self="closeRoleUsersModal">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body max-h-[calc(100vh-200px)] overflow-auto">
    ...
    @if ($roleAccessModalOpen)
        <div class="modal dashcode-detail-modal show" tabindex="-1" role="dialog" aria-modal="true" aria-labelledby="role-access-modal-title" wire:click.self="closeRoleAccessModal">
            <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                <div class="modal-content">
                        ...
                        @if ($roleAccessIsFull)
                            <div class="dashcode-alert dashcode-alert-success" role="note">
                                <div class="flex gap-2">
                                    ...
                                    <div>
                                        <div class="font-semibold">Akses penuh role default</div>
                            ...
                            @forelse ($roleAccessApps as $app)
                                <div class="border rounded overflow-hidden">
                                    <div class="flex items-center gap-2 bg-slate-50 px-3 py-2 border-bottom">
                                        ...
                                        <span class="badge bg-secondary-lt dashcode-push-right">{{ \Aldhi88\StarterKit\Support\Starter\StarterNumber::decimal(count($app['modules'])) }} module</span>
                                    </div>
                                    <div class="dashcode-stacked-list">
                    ...
                    <div class="modal-footer">
                        <div class="text-secondary small dashcode-grow">
