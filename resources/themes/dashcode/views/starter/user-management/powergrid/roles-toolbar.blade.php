<div class="p-4 space-y-3 md:flex md:flex-row md:space-y-0 justify-between">
    ...
    <div class="flex flex-1 flex-wrap items-center justify-end gap-3" data-starter-region="filters">
        <div class="flex-1 max-w-[180px]">
            <select class="form-control w-full" wire:model.live="archiveStatus" aria-label="Status arsip role">
        ...
        <label class="relative flex-1 max-w-md">
            ...
            <input type="search" class="form-control margin-0 !pl-12" placeholder="Cari nama, kode, atau deskripsi..." wire:model.live.debounce.350ms="search">
        </label>
    </div>
</div>
