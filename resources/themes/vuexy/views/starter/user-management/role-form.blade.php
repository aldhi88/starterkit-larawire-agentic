    ...
    <form id="role-form" wire:submit="save">
        <div class="row g-3 align-items-start" data-role-form-layout="split">
            <div class="col-12 col-xl-5" data-role-identity-panel data-starter-region="identity-form">
                <div class="card position-xl-sticky starter-sticky-card">
                    ...
                    <div class="card-body">
                        <div class="rounded border bg-body-tertiary p-3 mb-4" data-role-form-summary>
                            ...
                            <div class="d-flex flex-wrap align-items-center gap-2 mt-3">
                                @if ($isSuperuserRole)
                                    <span class="badge bg-label-danger">Role Sistem</span>
                                @elseif ($isCreating)
                                    <span class="badge bg-label-secondary">Belum Disimpan</span>
                                @else
                                    <span class="badge bg-label-success">Role Aktif</span>
                                @endif
                                ...
                                @endif
                                <span class="badge bg-label-secondary">{{ \Aldhi88\StarterKit\Support\Starter\StarterNumber::decimal($assignedUserCount) }} user</span>
                            </div>
                        </div>
                        ...
                        <div class="row g-3" data-role-system-access>
                            <div class="col-12">
                                <label class="form-check form-switch mb-4">
                                    ...
                                    <span class="form-check-label">
                                        <span class="d-flex align-items-center gap-2 fw-semibold mb-1">
                                            @include('starter.templates.layouts.icon', ['name' => 'settings', 'class' => 'icon-sm text-info'])
                                            Akses Pengaturan
                                        </span>
                                ...
                                <label class="form-check form-switch m-0">
                                    ...
                                    <span class="form-check-label">
                                        <span class="d-flex align-items-center gap-2 fw-semibold mb-1">
                                            @include('starter.templates.layouts.icon', ['name' => 'history', 'class' => 'icon-sm text-primary'])
                                            Lihat Log Aktivitas
                                        </span>
                                        <span class="d-block small text-secondary">
            ...
            <div class="col-12 col-xl-7" data-role-access-panel data-starter-region="module-access">
                <div class="card position-xl-sticky starter-sticky-card">
                    <div class="card-header d-flex align-items-center">
                        <div class="flex-grow-1 starter-min-width-zero">
                        ...
                        <div class="card-actions ms-3 flex-shrink-0">
                            <span class="d-inline-flex align-items-center justify-content-center px-2 py-1 rounded border {{ $isSuperuserRole ? 'border-success bg-label-success' : 'border-primary bg-label-primary' }} text-nowrap starter-access-badge">
                                ...
                                <div class="accordion-header">
                                    ...
                                    >
                                        <span class="me-auto">
                                            ...
                                            <span class="d-block small text-secondary">{{ \Aldhi88\StarterKit\Support\Starter\StarterNumber::decimal($appModules->count()) }} module tersedia</span>
                                        </span>
                                        <span class="badge {{ $grantedAppModules > 0 ? 'bg-label-primary' : 'bg-label-secondary' }}">
