<div>
    ...
    <div class="card">
        ...
        <div class="table-responsive">
            <table class="table table-vcenter table-hover card-table starter-role-summary-table">
                <thead>
                    <tr>
                        <th class="starter-role-column">Role</th>
                        <th class="text-nowrap starter-access-column">Cakupan Akses</th>
                        <th class="starter-user-column">User</th>
                        <th class="starter-action-column"></th>
                    </tr>
                </thead>
                <tbody>
                    @forelse ($roles as $role)
                        ...
                        @endphp
                        <tr
                            class="{{ $role->isSuperuser() ? 'bg-danger-subtle' : '' }}"
                        ...
                        >
                            <td>
                                <div class="d-flex align-items-center gap-3">
                                    <span
                                        class="avatar avatar-sm flex-shrink-0 {{ $role->isSuperuser() ? 'bg-label-danger' : 'bg-label-primary' }}"
                                        data-role-avatar
                                    >
                                    ...
                                    <div class="overflow-hidden">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            @if ($role->isSuperuser())
                                                <span class="badge bg-label-danger">Role Default</span>
                                            @endif
                            ...
                            <td class="text-nowrap">
                                ...
                                >
                                    <span class="avatar avatar-xs rounded {{ $role->isSuperuser() ? 'bg-label-success' : 'bg-label-primary' }} flex-shrink-0">
        ...
        <div class="modal modal-blur fade show d-block" tabindex="-1" role="dialog" aria-modal="true" aria-labelledby="role-users-modal-title" wire:click.self="closeRoleUsersModal">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body overflow-auto starter-role-users-scroll">
                            ...
                            <div class="card card-sm mb-3">
                                <div class="list-group list-group-flush">
                                    <div class="list-group-item">
                                        <div class="d-flex gap-2">
                                            @include('starter.templates.layouts.icon', ['name' => $roleAccessCanManageSettings ? 'settings' : 'lock', 'class' => 'icon-sm flex-shrink-0 mt-1 '.($roleAccessCanManageSettings ? 'text-info' : 'text-secondary')])
                                            <div>
                                    ...
                                    <div class="list-group-item">
                                        <div class="d-flex gap-2">
                                            @include('starter.templates.layouts.icon', ['name' => $roleAccessCanViewLogs ? 'history' : 'lock', 'class' => 'icon-sm flex-shrink-0 mt-1 '.($roleAccessCanViewLogs ? 'text-primary' : 'text-secondary')])
                                            <div>
                                                <div class="fw-semibold">
                            ...
                            @forelse ($roleAccessApps as $app)
                                <div class="border rounded overflow-hidden">
                                    <div class="d-flex align-items-center gap-2 bg-body-tertiary px-3 py-2 border-bottom">
                                        ...
                                        <span class="badge bg-label-secondary ms-auto">{{ \Aldhi88\StarterKit\Support\Starter\StarterNumber::decimal(count($app['modules'])) }} module</span>
                                    </div>
                                    <div class="list-group list-group-flush">
