            ...
            @if ($humanChallengeImage !== '')
                <div class="mb-4" data-starter-region="human-challenge">
                    ...
                    <div class="input-group flex-nowrap mb-2">
                        <span class="input-group-text flex-fill justify-content-center p-1 bg-lighter overflow-hidden">
                            <img src="{{ $humanChallengeImage }}" class="d-block w-100" width="286" height="76" alt="Lima angka keamanan acak">
                        </span>
