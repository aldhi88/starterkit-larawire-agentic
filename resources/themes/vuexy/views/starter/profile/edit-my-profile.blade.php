<div x-data="{ activeTab: @js($activeTab) }">
        ...
        <div class="alert alert-warning mb-3" role="alert" data-starter-region="status-alert">
            <div class="d-flex gap-3">
                ...
                <div>
                    ...
                    <div>
                        Masukkan password sementara yang Anda terima melalui email atau dari administrator pada kolom <strong>Password Saat Ini</strong>,
        ...
        <div class="card-body">
            <div class="row align-items-start g-3">
                ...
                <div class="col min-w-0">
                    ...
                    <div class="mt-2"><span class="badge bg-label-primary">{{ $login->role?->name ?? 'Tanpa Role' }}</span></div>
                </div>
    ...
    <div class="row g-3 align-items-stretch starter-profile-layout">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="list-group list-group-transparent" id="profile-settings-tabs" role="tablist">
                        ...
                        >
                            ...
                            Keamanan
                            @if ($login->must_change_password)
                                <span class="badge bg-label-warning ms-auto">Wajib</span>
                            @endif
                        </a>
                    </div>
                </div>
        ...
        <div class="col-12 col-lg-9" data-starter-region="section-content">
            <div class="tab-content starter-profile-tab-content">
                <form
                    id="account-details"
                ...
                >
                    <div class="card-header">
                        <div>
                            ...
                            <div class="text-secondary small mt-1">Perbarui foto, username, nama tampilan, dan email yang digunakan untuk login.</div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="mb-4">
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col">
                                    <div class="btn-list">
                                        ...
                                        <button type="button" class="btn btn-label-secondary" data-bs-toggle="modal" data-bs-target="#delete-profile-photo-modal">Hapus Foto Profil</button>
                                    </div>
